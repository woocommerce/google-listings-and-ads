...
<div id="gla_attributes" class="panel woocommerce_options_panel">
	...
	<p class="show_if_variable"><?php esc_html_e( 'As this is a variable product, you can add additional product attributes by going to Variations > Select one variation > Google Listings & Ads.', 'google-listings-and-ads' ); ?></p>
	<?php
