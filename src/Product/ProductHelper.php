...
class ProductHelper implements Service {
	 ...
	 *
	 * @param string $mc_product_id Can be formatted as simply 'merchant_center_id' or
	 *                              as 'online:en:GB:merchant_center_id'
	 *
	...
	public function get_wc_product_id( string $mc_product_id ): int {
		 ...
		 * @param string $mc_product_id Merchant Center product ID without any target info (i.e., just product
		 *                              ID without preceding data with colons, etc).
		 * @since x.x.x
		 *
