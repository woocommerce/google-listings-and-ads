...
class RESTServiceProvider extends AbstractServiceProvider {
	...
	public function register() {
		...
		$this->share( MerchantCenterAccountReviewController::class, RequestReview::class );
		...
		$this->share( TargetAudienceController::class, WP::class, WC::class, ShippingZone::class );
