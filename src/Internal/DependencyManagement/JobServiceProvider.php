...
class JobServiceProvider extends AbstractServiceProvider {
	...
	public function register(): void {
		...
		$this->share_with_tags( ProductSyncCount::class, ActionScheduler::class );
		...
		$this->share_product_syncer_job( RefreshSyncedProducts::class );
		...
		$this->share_with_tags( StartProductSync::class );
	}
