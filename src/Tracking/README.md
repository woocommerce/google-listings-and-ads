...
### [`gla_add_market_button_clicked`](../../js/src/pages/markets/add-market-button.js#L15)
Event fired when the "Add market" button is clicked.
#### Emitters
- [`AddMarketButton`](../../js/src/pages/markets/add-market-button.js#L25) event when the button is clicked

### [`gla_add_new_market_button_clicked`](../../js/src/pages/markets/add-market-modal/index.js#L31)
...
#### Emitters
- [`AddMarketModal`](../../js/src/pages/markets/add-market-modal/index.js#L50) when the add market button is clicked with context of "add_market_modal"
...
### [`gla_cancel_button_clicked`](../../js/src/pages/markets/add-market-modal/index.js#L25)
...
#### Emitters
- [`AddMarketModal`](../../js/src/pages/markets/add-market-modal/index.js#L50) when the cancel button is clicked with context of "add_market_modal"
- [`EditMarketModal`](../../js/src/pages/markets/edit-market-modal/index.js#L45) when the cancel button is clicked with context of "edit_market_modal"

### [`gla_cancel_button_clicked`](../../js/src/pages/markets/edit-market-modal/index.js#L22)
...
### [`gla_save_button_clicked`](../../js/src/pages/markets/edit-market-modal/index.js#L28)
...
#### Emitters
- [`EditMarketModal`](../../js/src/pages/markets/edit-market-modal/index.js#L45) when the save button is clicked with context of "edit_market_modal"
