...
### [`gla_add_market_button_clicked`](../../js/src/pages/markets/add-market-button.js#L16)
...
### [`gla_cancel_button_clicked`](../../js/src/pages/markets/add-market-modal/index.js#L26)
...
#### Emitters
- [`AddMarketModal`](../../js/src/pages/markets/add-market-modal/index.js#L52) when the cancel button is clicked with context of "add_market_modal"
- [`EditMarketModal`](../../js/src/pages/markets/edit-market-modal/index.js#L50) when the cancel button is clicked with context of "edit_market_modal"

### [`gla_cancel_button_clicked`](../../js/src/pages/markets/edit-market-modal/index.js#L23)
...
- [`MarketNotice`](../../js/src/pages/markets/market-notice/index.js#L22) with `{ context: "edit-market-modal", link_id: "market-notice-merchant-center", href: "https://merchants.google.com/" }`
...
### [`gla_save_button_clicked`](../../js/src/pages/markets/edit-market-modal/index.js#L29)
...
#### Emitters
- [`EditMarketModal`](../../js/src/pages/markets/edit-market-modal/index.js#L50) when the save button is clicked with context of "edit_market_modal"
