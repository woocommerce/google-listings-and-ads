...
- [`EditMarketModal`](../../js/src/pages/markets/edit-market-modal/index.js#L46) when the cancel button is clicked with context of "edit_market_modal"
...
- [`MarketNotice`](../../js/src/pages/markets/market-notice/index.js#L25) with `{ context: props.context, link_id: "market-notice-merchant-center", href: "https://merchants.google.com/" }`
...
#### Emitters
- [`EditMarketModal`](../../js/src/pages/markets/edit-market-modal/index.js#L46) when the save button is clicked with context of "edit_market_modal"
