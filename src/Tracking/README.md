...
### [`gla_google_account_connect_button_click`](js/src/utils/recordEvent.js#L199)
...
### [`gla_google_mc_link_click`](js/src/utils/recordEvent.js#L209)
...
### [`gla_launch_paid_campaign_button_click`](js/src/utils/recordEvent.js#L174)
...
- [`recordLaunchPaidCampaignClickEvent`](js/src/utils/recordEvent.js#L190)
...
### [`gla_modal_closed`](js/src/utils/recordEvent.js#L217)
A modal is closed.
#### Properties
|   |   |   |
|---|---|---|
...
### [`gla_setup_ads`](js/src/utils/recordEvent.js#L154)
...
- [`recordSetupAdsEvent`](js/src/utils/recordEvent.js#L167) with given `{ target, trigger }`.
...
### [`gla_setup_mc`](js/src/utils/recordEvent.js#L130)
...
- [`recordSetupMCEvent`](js/src/utils/recordEvent.js#L143) with the given `{ target trigger }`.
