...
### [`gla_add_market_button_clicked`](../../js/src/pages/markets/components/add-market-button.js#L16)
Event fired when the "Add market" button is clicked.
#### Emitters
- [`AddMarketButton`](../../js/src/pages/markets/components/add-market-button.js#L30) event when the button is clicked
...
### [`gla_analytics_in_product_placements_dismiss`](../../js/src/components/analytics-overview-promo/index.js#L155)
...
#### Emitters
- [`AnalyticsOverviewPromo`](../../js/src/components/analytics-overview-promo/index.js#L176)

### [`gla_analytics_in_product_placements_get_started_click`](../../js/src/components/analytics-overview-promo/index.js#L139)
...
### [`gla_analytics_in_product_placements_launch_campaign_click`](../../js/src/components/analytics-overview-promo/index.js#L147)
...
### [`gla_analytics_in_product_placements_view`](../../js/src/components/analytics-overview-promo/index.js#L129)
...
### [`gla_datepicker_update`](../../js/src/utils/tracks.js#L163)
...
### [`gla_filter`](../../js/src/utils/tracks.js#L175)
...
### [`gla_google_account_connect_button_click`](../../js/src/utils/tracks.js#L207)
...
### [`gla_google_mc_link_click`](../../js/src/utils/tracks.js#L217)
...
### [`gla_launch_paid_campaign_button_click`](../../js/src/utils/tracks.js#L195)
...
### [`gla_modal_closed`](../../js/src/utils/tracks.js#L273)
A modal is closed.
#### Properties
| name | type | description |
| ---- | ---- | ----------- |
...
### [`gla_modal_open`](../../js/src/utils/tracks.js#L286)
A modal is open
#### Properties
| name | type | description |
| ---- | ---- | ----------- |
...
### [`gla_paid_campaign_step`](../../js/src/utils/tracks.js#L233)
...
### [`gla_setup_ads`](../../js/src/utils/tracks.js#L225)
...
### [`gla_setup_mc`](../../js/src/utils/tracks.js#L186)
...
### [`gla_table_go_to_page`](../../js/src/utils/tracks.js#L65)
...
#### Emitters
- [`ProductFeedTableCard`](../../js/src/pages/product-feed/product-feed-table-card/index.js#L65) with `context: 'product-feed'`
- [`recordTablePageEvent`](../../js/src/utils/tracks.js#L149) with the given `{ context, page }`.
...
### [`gla_table_page_click`](../../js/src/utils/tracks.js#L73)
...
#### Emitters
- [`ProductFeedTableCard`](../../js/src/pages/product-feed/product-feed-table-card/index.js#L65) with `context: 'product-feed'`
- [`recordTablePageEvent`](../../js/src/utils/tracks.js#L149) with the given `{ context, direction }`.
