...
test.describe( 'Confirm store requirements', () => {
	...
	test.describe( 'Pre-Launch Checklist', () => {
		...
		test.describe( 'When the policy checks are not compliant and settings are false', () => {
			test.beforeAll( async () => {
			...
			test( 'should toggle all checklists and see the "Confirm" button in each checklist', async () => {
				const panels = storeRequirements.getPrelaunchChecklistPanels();
			...
			test( 'should see error message after clicking "Continue" when any one of the checkboxes was not checked', async () => {
				...
				const errorMessageRow = storeRequirements.getErrorMessageRow();
		...
		test.describe( 'When the policy checks are compliant and settings are true', () => {
			test.beforeAll( async () => {
