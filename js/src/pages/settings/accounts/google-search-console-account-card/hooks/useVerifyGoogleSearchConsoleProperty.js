...
/**
 * A hook that verifies the merchant's Google Search Console property and refreshes connection state.
 *
 * @return {{ verify: Function, loading: boolean }} Click handler to wire to the verify button, and whether a request is in flight.
 */
const useVerifyGoogleSearchConsoleProperty = () => {
...
export default useVerifyGoogleSearchConsoleProperty;
