 ...
 * @param {string} props.title Title to be shown
 * @param {Array<JSX.Element>} props.children Additional elements to be put in the top bar.
 */
const TopBar = ( { onBackButtonClick, backHref, title, children } ) => {
	return (
