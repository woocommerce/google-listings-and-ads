 ...
 *
 * @param {Object} props
 * @param {JSX.Element} props.submitButtonChildren Children for the submit button.
 * @param {Array<Button>} [props.additionalButtons=[]] Additional buttons to be rendered in `AppModal`'s `buttons` prop, before the submit button.
