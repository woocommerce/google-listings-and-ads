...
const faqItems = [
	...
	},
	{
		...
		question: __( 'What is a service feed?', 'google-listings-and-ads' ),
		answer: __(
			'Your service feed is the central data source that contains a list of products you want to advertise through Merchant Center. By default, Google syncs all active products from your WooCommerce inventory. You can choose to exclude products later after this setup.',
			'google-listings-and-ads'
		),
	},
	{
		trackId: 'how-much-does-ads-cost',
		question: __( 'How much does ads cost?', 'google-listings-and-ads' ),
		answer: __(
	...
	{
		trackId: 'where-will-my-service-appear',
		question: __(
			'Where will my service appear?',
			'google-listings-and-ads'
		),
		answer: __(
