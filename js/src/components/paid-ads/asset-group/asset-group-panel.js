...
export default function AssetGroupCard() {
	...
	return (
		<div key={ finalUrl } className="gla-asset-group-panel">
			<Section
				...
				className="gla-asset-group-panel-section"
			>
				...
				description={
					<div className="gla-asset-group-section__primary-description">
						...
						<ul>
							...
							<li>
								{ __( '1x logo', 'google-listings-and-ads' ) }
							</li>
						</ul>
						<p>
							<AppDocumentationLink
