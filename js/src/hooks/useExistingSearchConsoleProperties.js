 ...
 * REST resolver of its own — Search Console mirrors YouTube's single-endpoint store shape (per the
 * plan's Key Decisions), so the candidate `properties` list is already part of the single Search
