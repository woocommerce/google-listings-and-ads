 ...
 * @param {( location: Object ) => boolean} [promptFn] Function to filter specific locations for blocking when navigating using woocommerce/navigation.
 */
