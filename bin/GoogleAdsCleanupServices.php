...
class GoogleAdsCleanupServices {
	...
	protected $avoid_cleanup = [
		...
		// upgrading to v19, so we need to keep this service. See:
		// - https://github.com/googleads/google-ads-php/blob/v27.2.0/src/Google/Ads/GoogleAds/Util/V18/ResourceNames.php#L1704-L1710
		// - https://github.com/googleads/google-ads-php/blob/v27.2.0/src/Google/Ads/GoogleAds/Util/V19/ResourceNames.php#L1433-L1439
		'BatchJob',
	];
